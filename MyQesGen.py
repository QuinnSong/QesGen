...
from kidsmode import isExpValid, hasCarryOrBorrow, convertToDecimal
import codecs
...
class ExpressionGenerator ( wx.Dialog ):
        ...
        def __init__( self, parent ):
                ...
                self.m_comboBoxFontSize = wx.ComboBox( self.m_panelGen, wx.ID_ANY, u"大小", wx.DefaultPosition, wx.Size( 60,-1 ), m_comboBoxFontSizeChoices, wx.CB_READONLY|wx.NO_BORDER )
                ...
                self.m_btnBg = wx.Button( self.m_panelGen, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 22,-1 ), 0|wx.NO_BORDER )
                ...
                self.m_btnFg = wx.Button( self.m_panelGen, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 22,-1 ), 0|wx.NO_BORDER )
                ...
                self.m_filePickerQues = wx.FilePickerCtrl( sbSizerSavePath.GetStaticBox(), wx.ID_ANY, self.ques_path, u"请选择一个文本文件", u"*.txt", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE|wx.FLP_SMALL )
